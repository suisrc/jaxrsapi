 ...
 * 代码参考wildfly-swarm
 * 
 * @see org.wildfly.swarm.cdi.jaxrsapi.runtime.ServiceClientProcessor 采用ASM方式进行生成，相对于编程困难且难以维护
 * @see ClientServiceFactory
 * @author Y13
 * 
 * @since 170626 弃用
 *
...
//    }
//
//    static void createMethod(ClassWriter cw, String implName, String clientInterfaceName, MethodInfo method, int lineNum,
//            String baseUrl) {
//        MethodVisitor mv;
//
//        {
...
//            mv.visitMethodInsn(INVOKEINTERFACE, clientInterfaceName.replace('.', '/'), method.name(), buildMethodDef(method),
//                    true);
//            Label l5 = new Label();
//            mv.visitLabel(l5);
...
//                    mv.visitLocalVariable(String.valueOf(anno.value().value()), buildTypeDef(parameterType.name().toString()),
//                            null, l0, l6, methodParams++);
//                }
//            }
