...
public interface TestRest3 {
    ...
    @Path("cgi-bin/token")
    @Produces(MediaType.APPLICATION_JSON)
    String getApi_2(@Value("T:grant_type") String grantType, @Value("appid") String appid,  @DefaultValue("secret") String secret);
    ...
    @Path("cgi-bin/token")
    @Produces(MediaType.APPLICATION_JSON)
    String getApi_3(@Value("grant_type") String grantType, @Value("appid") String appid,  @DefaultValue("secret") String secret);
    ...
    @Path("cgi-bin/token")
    @Produces(MediaType.APPLICATION_JSON)
    String getApi_4(@Value("grant_type") String grantType, @Value("appid") String appid,  @DefaultValue("secret") String secret);
    ...
    String getApi_5(@Reviser(TReviseHandler.class)@Value("grant_type") String grantType);
}
